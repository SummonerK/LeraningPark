...
class TBCalendarDateCell: UICollectionViewCell {
    ...
    lazy var dotView: UIView = self.getDotView()
    public var isToday: Bool?
    
    lazy var descLabel: UILabel = self.getDescLabel()
    ...
    override func layoutSubviews() {
        ...
        if(self.dateLableHeight > 0)
        {
            ...
            self.dotView.centerX = self.dateLabel.width * 0.5;
            self.dotView.centerY = self.dateLabel.height * 0.5 + 10;
