...
class TBCalendar: UIView, UICollectionViewDelegate, UICollectionViewDataSource{
    ...
    lazy var contentView: UIView = self.getContentView()
    lazy var collectionView: UICollectionView = self.getCollectionView()
    lazy var collectFlowLayout: UICollectionViewFlowLayout = self.getCollectFlowLayout()
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        didSelectDate(date: date as NSDate)
