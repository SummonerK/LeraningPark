...
//  RxText01
//
//  Created by Luofei on 2018/8/17.
//  Copyright © 2018年 FreeMud. All rights reserved.
//

import UIKit

class MYCalendarVC:UIViewController , TBCalendarDataDelegate , TBCalendarDataSource{
...
//        self.navigationController?.popViewController(animated: true)
    ...
    func calender(calender: TBCalendar, didSelectDate: NSDate) -> Void{
        
        print("calender didSelectDate\(didSelectDate)")
    }
}
