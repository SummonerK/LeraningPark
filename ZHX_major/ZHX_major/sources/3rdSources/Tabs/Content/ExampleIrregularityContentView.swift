...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        textColor = UIColor.init(red: 99/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
        highlightTextColor = UIColor.init(white: 46.0 / 255.0, alpha: 1.0)
...
//        textColor = UIColor.init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
